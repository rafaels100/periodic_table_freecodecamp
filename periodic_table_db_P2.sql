...
--
-- Name: copia_properties; Type: TABLE; Schema: public; Owner: root
--

CREATE TABLE public.copia_properties (
    atomic_number integer,
    type character varying(30),
    atomic_mass numeric(8,4),
...
ALTER TABLE public.copia_properties OWNER TO root;
...
--
-- Name: types_type_id_seq; Type: SEQUENCE; Schema: public; Owner: root
--
...
ALTER TABLE public.types_type_id_seq OWNER TO root;

--
-- Name: types_type_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: root
--
...
--
-- Name: types type_id; Type: DEFAULT; Schema: public; Owner: root
--
...
--
-- Data for Name: copia_properties; Type: TABLE DATA; Schema: public; Owner: root
--

INSERT INTO public.copia_properties VALUES (7, 'nonmetal', 14.0070, -210.1, -195.8, 1);
INSERT INTO public.copia_properties VALUES (6, 'nonmetal', 12.0110, 3550, 4027, 1);
INSERT INTO public.copia_properties VALUES (2, 'nonmetal', 4.0026, -272.2, -269, 1);
INSERT INTO public.copia_properties VALUES (1, 'nonmetal', 1.0080, -259.1, -252.9, 1);
INSERT INTO public.copia_properties VALUES (4, 'metal', 9.0122, 1287, 2470, 2);
INSERT INTO public.copia_properties VALUES (3, 'metal', 6.9400, 180.54, 1342, 2);
INSERT INTO public.copia_properties VALUES (1000, 'metalloid', 1.0000, 10, 100, 3);
INSERT INTO public.copia_properties VALUES (5, 'metalloid', 10.8100, 2075, 4000, 3);
INSERT INTO public.copia_properties VALUES (8, 'nonmetal', 15.9990, -218, -183, 1);


--
-- Data for Name: elements; Type: TABLE DATA; Schema: public; Owner: root
--
...
--
-- Name: types_type_id_seq; Type: SEQUENCE SET; Schema: public; Owner: root
--
...
--
-- Name: elements elements_atomic_number_key; Type: CONSTRAINT; Schema: public; Owner: root
--
...
--
-- Name: elements elements_name_key; Type: CONSTRAINT; Schema: public; Owner: root
--
...
--
-- Name: elements elements_symbol_key; Type: CONSTRAINT; Schema: public; Owner: root
--
...
--
-- Name: properties properties_atomic_number_key; Type: CONSTRAINT; Schema: public; Owner: root
--
...
--
-- Name: properties properties_atomic_number_fkey; Type: FK CONSTRAINT; Schema: public; Owner: root
--
...
--
-- Name: properties properties_type_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: root
--
